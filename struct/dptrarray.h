...
void *dptrarray_at(DPtrArray *, uint) NONNULL();
void dptrarray_clear(DPtrArray *) NONNULL();
void dptrarray_destroy(DPtrArray *) NONNULL();
void dptrarray_insert(DPtrArray *, uint, void *) NONNULL(1);
size_t dptrarray_length(DPtrArray *) NONNULL();
DPtrArray *dptrarray_new(func_dtor_t) WARN_UNUSED_RESULT;
...
DPtrArray *dptrarray_sized_new(size_t, func_dtor_t) WARN_UNUSED_RESULT;
void dptrarray_swap(DPtrArray *, uint, uint) NONNULL();
