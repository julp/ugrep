...
assertOutputValue "tr grapheme deletion" "./utr ${UGREP_OPTS} --form=d -d ${E_ACUTE_NFD} ${E_ACUTE_NFD}${A_ACUTE_NFD} 2> /dev/null" "${A_ACUTE_NFD}"
assertOutputValue "tr grapheme replacement" "./utr ${UGREP_OPTS} --form=d ${E_ACUTE_NFD} X ${E_ACUTE_NFD}${A_ACUTE_NFD} 2> /dev/null" "X${A_ACUTE_NFD}"
